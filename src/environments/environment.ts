...
export const environment = {
  ...
  dashboardCEO: apiUrl + 'flows/trigger/f1c8e7fa-e0f5-4aab-a2dd-4dea336ef947',
  ...
  notify_acudiente_flow: apiUrl + 'flows/trigger/ddbcef22-64cb-4858-a00d-d5fd1837faca',
  consultar_acudiente_ayo: apiUrl + 'flows/trigger/8abc9d58-c405-44b4-b405-f4a265a7d505',
